...
Sidste test er i virkeligheden flere test der kører på en fil, men det gav mening at køre test på den, da den rent faktisk var en fil for sig selv i produktion. Alle filer og test filer kan til gå på developerbranchen [https://github.com/Stikkelmaal123/team-docs/developer](her.)
